...
export declare class DrawingEntitiesManager {
    ...
    addMonomerChangeModel(monomerItem: MonomerItemType, position: Vec2, _monomer?: BaseMonomer): AmbiguousMonomer | BaseMonomer;
    createMonomer(monomerItem: MonomerOrAmbiguousType, position: Vec2): Sugar | Phosphate | RNABase | AmbiguousMonomer | Chem | import("./").Peptide;
    ...
    addAtom(position: Vec2, monomer: BaseMonomer, atomIdInMicroMode: number, label: AtomLabel): Command;
    private deleteAtomChangeModel;
    private deleteAtom;
    private addBondChangeModel;
    addBond(firstAtom: Atom, secondAtom: Atom, type: number, stereo: number): Command;
