...
export declare abstract class BaseMonomer extends DrawingEntity {
    ...
    getAttachmentPointByBond(bond: PolymerBond | MonomerToAtomBond): AttachmentPointName | undefined;
    ...
    forEachBond(callback: (polymerBond: PolymerBond | MonomerToAtomBond, attachmentPointName: AttachmentPointName) => void): void;
    setBond(attachmentPointName: AttachmentPointName, bond: PolymerBond | MonomerToAtomBond): void;
